#!/home/ricky/programs/python/checkio/venv/bin/checkio --domain=py run popular-words
...
# 
# Precondition:
# The input text will consist of English letters in uppercase and lowercase and whitespaces.
# 
# 
# END_DESC
...
def popular_words(text: str, words: list) -> dict:
    ...
    for word in words:
        if word not in text_list:
            ...
            popular_dict[word] = text_list.count(word)
    return popular_dict
